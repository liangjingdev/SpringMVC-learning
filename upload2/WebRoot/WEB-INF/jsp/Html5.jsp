...
<!-- 该页面包含的JavaScript代码允许用户选择多个文件，并且一键单击即可全部上传。这些文件将同时上传 -->
<!DOCTYPE html>
<html>
<head>
<script>
    ...
    function uploadNext() {
        ...
        xhr.open("POST", "file_upload");  //调用Html5FileUploadController中的saveFile()方法
...
<form>
    ...
    <!-- 这个按钮不是一个提交按钮，单击它并不会提交表单，事实上，脚本是利用XMLHttpRequest对象来完成上传的 -->
